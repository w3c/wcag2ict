This is a W3C Group Note on Applying WCAG 2 to Non-Web Information and Communications Technologies (WCAG2ICT). This supersedes the previous [Guidance on Applying Web Content Accessibility Guidelines (WCAG) 2.0](https://www.w3.org/TR/wcag2ict-20/). This updated Note:

* includes changes made in WCAG 2.1 and 2.2,
* addresses public feedback, and
* adds guidance for Level AAA success criteria.
