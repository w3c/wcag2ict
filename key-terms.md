...
This draft of WCAG2ICT introduced three new key terms: [closed functionality](#closed-functionality), [menu driven interface](#menu-driven-interface), and [platform software](platform-software).  
</div>
