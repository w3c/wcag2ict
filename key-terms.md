...
This draft of WCAG2ICT introduced two new key terms: [closed functionality](#closed-functionality-as-used-in-WCAG2ICT) and [menu driven interface](#menu-driven-interface).  
</div>
