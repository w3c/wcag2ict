...
Since any content that does not meet this success criterion can interfere with a user's ability to use the <INS>**[whole non-web document or software]**</INS>, all content <INS>**[in the non-web document or software]**</INS> (whether or not it is used to meet other success criteria) <INS>**[would need to]**</INS> meet this success criterion.</div>
