...
There are cases where non-web software has an authentication process and no alternative or assistance mechanism is feasible, for example when entering a password on first start of a product. In such situations, it may not be possible for the non-web software to meet this success criterion.</div>
<div class="note">
