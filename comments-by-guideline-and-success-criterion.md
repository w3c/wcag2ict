...
#### Applying Principle 1 Perceivable to non-web documents and non-web software
...
##### Applying Guideline 1.1 Text Alternatives to non-web documents and non-web software
...
###### Applying SC 1.1.1 Non-text Content to non-web documents and non-web software
...
##### Applying Guideline 1.2 Time Based Media to non-web documents and  non-web software
...
###### Applying SC 1.2.1 Audio-only and Video-only (Prerecorded) to non-web documents and non-web software
...
###### Applying SC 1.2.2 Captions (Prerecorded) to non-web documents and non-web software
...
###### Applying SC 1.2.3 Audio Description or Media Alternative (Prerecorded) to non-web documents and non-web software
...
###### Applying SC 1.2.4 Captions (Live) to non-web documents and non-web software
...
###### Applying SC 1.2.5 Audio Description (Prerecorded) to non-web documents and non-web software
...
##### Applying Guideline 1.3 Adaptable to non-web documents and non-web software
...
###### Applying SC 1.3.1 Info and Relationships to non-web documents and non-web software
...
###### Applying SC 1.3.2 Meaningful Sequence to non-web documents and non-web software
...
###### Applying SC 1.3.3 Sensory Characteristics to non-web documents and non-web software
...
###### Applying SC 1.3.5 Identify Input Purpose to non-web documents and non-web software
...
##### Applying Guideline 1.4 Distinguishable to non-web documents and non-web software
...
###### Applying SC 1.4.1 Use of Color to non-web documents and non-web software
...
###### Applying SC 1.4.3 Contrast Minimum to non-web documents and non-web software
...
###### Applying SC 1.4.5 Images of Text to non-web documents and non-web software
...
###### Applying SC 1.4.10 Reflow to non-web documents and non-web software
...
###### Applying SC 2.1.4 Character Key Shortcuts to non-web documents and non-web software
...
##### Applying Guideline 2.2 Enough Time to non-web documents and non-web software
...
##### Applying Guideline 2.3 Seizures and Physical Reactions to non-web documents and non-web software
...
##### Applying Guideline 2.4 Navigable to non-web documents and non-web software
...
Although not required by the success criterion, being able to bypass blocks of content that are repeated _within_ non-web documents or non-web software directly addresses user needs identified in the Intent section for this success criterion, and is generally considered best practice.</div>
<div class="note wcag2ict software">
...
The definitions of “[set of documents](#set-of-documents)” and “[set of software programs](#set-of-software-programs)” in the Key Terms section are predicated on the ability to navigate from each element of the set to each other, and navigation is a type of locating. So the mechanism used to navigate between elements of the set will be one way of locating information in the set. Non-web environments, generally major operating systems with browse and search capabilities, often provide infrastructure and tools that provide mechanisms for locating content in a set of non-web documents or a set of non-web software programs. For example, it may be possible to browse through the files or programs that make up a set, or search within members of the set for the names of other members. A file directory would be the equivalent of a site map for documents in a set, and a search function in a file system would be equivalent to a web search function for web pages. Such facilities may provide additional ways of locating information in the set.</div>
<div class="note wcag2ict">
    
While some users may find it useful to have multiple ways to locate some groups of user interface elements within a non-web document or non-web software program, this is not required by the success criterion (and may pose difficulties in some situations).</div>
<div class="note wcag2ict">
...
###### Applying SC 2.4.6 Headings and Labels to non-web documents and non-web software
...
###### Applying SC 2.4.7 Focus Visible to non-web documents and non-web software
...
###### Applying SC 2.4.11 Focus not Obscured to non-web documents and non-web software
...
##### Applying Guideline 2.5 Input Modalities to non-web documents and non-web software
...
###### Applying SC 2.5.1 Pointer Gestures to non-web documents and non-web software
...
###### Applying SC 2.5.2 Pointer Cancellation to non-web documents and non-web software
...
###### Applying SC 2.5.3 Label in Name to non-web documents and non-web software
...
###### Applying SC 2.5.4 Motion Actuation to non-web documents and non-web software
...
###### Applying SC 2.5.7 Dragging Movements to non-web documents and non-web software
...
<dt>Equivalent</dt>
<dd>The function can be achieved through a different control <INS>[in the same <strong><a href="#document">non-web document</a></strong>]</INS> or <INS>[in the same <strong><a href="#software">non-web software</a></strong>]</INS> that meets this criterion.</dd>
<dt>Inline</dt>
...
#### Applying Principle 3 Understandable to non-web documents and non-web software
...
##### Applying Guideline 3.1 Readable to non-web documents and non-web software
...
###### Applying SC 3.2.1 On Focus to non-web documents and non-web software
...
###### Applying SC 3.2.2 On Input to non-web documents and non-web software
...
**3.2.6 Consistent Help:** If a <INS>[**[non-web document](#document)** or **[non-web software](#software)**]</INS> contains any of the following help [mechanisms](https://www.w3.org/TR/WCAG22/#dfn-mechanism), and those mechanisms are repeated <INS>[in multiple non-web documents or non-web software]</INS> within a <INS>[**[set of non-web documents](#set-of-documents)** or **[set of non-web software programs](#set-of-software-programs)**]</INS>, they occur in the same order relative to other <INS>[**[content](#content-on-and-off-the-web)**]</INS>, unless a change is initiated by the user:
...
##### Applying Guideline 3.3 Input Assistance to non-web documents and non-web software
...
###### Applying SC 3.3.1 Error Identification to non-web documents and non-web software
...
###### Applying SC 3.3.2 Labels or Instructions to non-web documents and non-web software
...
###### Applying SC 3.3.7 Redundant Entry to non-web documents and non-web software
...
This applies directly as written, and as described in [Intent from Understanding Success Criterion 3.3.8](https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication-minimum.html), replacing “the website” with “non-web document" or "non-web software”.
...
<dd>The cognitive function test is to identify <a href="https://www.w3.org/TR/WCAG22/#dfn-non-text-content">non-text content</a> the user provided to a <INS>[<strong><a href="#document">non-web document</a></strong>]</INS> or <INS>[<strong><a href="#software">non-web software</a></strong>]</INS>.</dd>
</dl>
<div class="note">
...
#### Applying Principle 4 Robust to non-web documents and non-web software
...
##### Applying Guideline 4.1 Compatible to non-web documents and non-web software
...
###### Applying SC 4.1.1 Parsing (WCAG 2.0 and 2.1) to non-web documents and non-web software

This applies directly as written, and as described in [Intent from Understanding Success Criterion 4.1.1](https://www.w3.org/WAI/WCAG21/Understanding/parsing#intent), replacing “In content implemented using markup languages” with “For non-web documents that use markup languages" or "For non-web software that use markup languages", and add "in such a way that the markup is separately exposed and available to assistive technologies and accessibility features of software or to a user-selectable user agent” and replacing the WCAG notes with notes applicable to non-web documents and non-web software.

With this substitution, it would read:

<strong>4.1.1 Parsing:</strong> <INS>[For **[non-web documents](#document)** that use markup languages]</INS> or <INS>[For **[non-web software](#software)** that use markup languages]</INS>, <INS>[in such a way that the markup is separately exposed and available to **[assistive technologies](#dfn-assistive-technologies)** and accessibility features of software or to a user-selectable **[user agent](#user-agent)**]</INS>, elements have complete start and end tags, elements are nested according to their specifications, elements do not contain duplicate attributes, and any IDs are unique, except where the specifications allow these features.
<div class="note wcag2ict">
...
* Non-web documents or non-web software are not authored using a markup language.
* Non-web documents or non-web software are authored using a markup language, but accessibility information is exposed via platform accessibility APIs, not by making the markup itself available to assistive technologies.
</div>
...
###### Applying SC 4.1.1 Parsing (Obsolete and removed) (WCAG 2.2) to non-web documents and non-web software

<div class="note wcag2ict">

WCAG 2.2 has made this success criterion obsolete and removed it as a requirement in the standard. Therefore, the interpretation of this success criterion for [non-web documents](#document) and [non-web software](#software) has been removed.</div>

##### name-role-value

###### Applying SC 4.1.2 Name, Role, Value to non-web documents and non-web software
...
###### Applying SC 4.1.3 Status Messages to non-web documents and non-web software
...
For [non-web documents](#document) and [non-web software](#software) where status messages are not implemented using markup languages, there is still a user need to have status messages be programmatically exposed so that they can be presented to the user by assistive technologies without receiving focus. This is typically enabled through the use of accessibility services of the [user agent](#user-agent) or other [platform software](#platform-software).</div>
