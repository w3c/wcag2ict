...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Sign Language (Prerecorded)](#problematic-for-closed-sign-language-prerecorded).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Media Alternative (Prerecorded)](#problematic-for-closed-media-alternative-prerecorded).
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Audio-only (Live)](#problematic-for-closed-audio-only-live).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Identify Purpose](#problematic-for-closed-identify-purpose).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Visual Presentation](#problematic-for-closed-visual-presentation).
</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Images of Text (No Exception)](#problematic-for-closed-images-of-text-no-exception).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Keyboard (No Exception)](#problematic-for-closed-keyboard-no-exception).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Re-authenticating](#problematic-for-closed-re-authentication).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Location](#problematic-for-closed-location).
</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Section Headings](#problematic-for-closed-section-headings).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Focus Not Obscured (Enhanced)](#problematic-for-closed-focus-not-obscured).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Focus Appearance](#problematic-for-closed-focus-appearance).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Target Size (Enhanced)](#problematic-for-closed-target-size-enhanced).</div>
...
For general guidance, see also the [comments on closed functionality](#comments-on-closed-functionality). For commentary on the individual success criterion, see [Success criteria problematic for closed functionality, Help](#problematic-for-closed-help).</div>
