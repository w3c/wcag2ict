...
The glossary terms in WCAG 2 were also reviewed and most of them applied to non-web documents and software, as written. Some applied with additional notes or edits (largely related to phrases like “web page(s)”), and a small number of terms are only used in AAA success criteria.  Level AAA success criteria were not addressed by previous versions of the WCAG2ICT Note.
