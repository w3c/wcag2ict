...
* WCAG2ICT is not sufficient by itself to ensure accessibility in non-web documents and software.  This is because WCAG2ICT does not address accessibility requirements beyond those covered by WCAG, which, as a web standard, does not fully cover all accessibility requirements for:
