...
WCAG2ICT’s guidance for [documents](#document) is technically scoped to [non-web documents](#document) (in other words, those distributed outside of websites).</div>
