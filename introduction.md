...
<div class="ednote"><p>This section contains a first pass of updates. It will be re-examined once the Task Force has finished analyzing all of the new WCAG criteria to ensure the summarization of applicability of WCAG criteria to non-web documents and software is accurate.</p></div>
...
<div class="note"><p>Hereafter, the use of WCAG 2 means all WCAG 2.x versions &ndash; 2.0, 2.1, and 2.2.</p></div>
...
<div class="note"><p>Sets of software that meet this definition appear to be extremely rare.</p></div>
...
<div class="ednote"><p>The visual styling and programmatic structure details for calling out content in this section are current for this draft. This section will be revisited when further style details are worked out.</p></div>
...
<div class="ednote"><p>The WCAG2ICT Task Force has incorporated all of the new WCAG 2.1 guidelines, criteria and glossary terms. The next draft version will incorporate new WCAG 2.2 criteria and glossary terms as well as address open issues on any of the content in the document.</p>
