...
A [Working Group Note](http://www.w3.org/2005/10/Process-20051014/tr#WGNote) for W3C on the topic of applying WCAG 2.0 to non-web content was approved in September of 2013.  That Working Group Note, [Guidance on Applying WCAG 2.0 to Non-Web Information and Communications Technologies (WCAG2ICT)](https://www.w3.org/TR/2013/NOTE-wcag2ict-20130905/) describes how WCAG 2.0 can be applied to ICT, specifically to non-web documents and software.  WCAG21CT is organized by sections to mirror those found in WCAG 2.0: perceivable, operable, understandable, and robust.  WCAG2ICT is intended to help clarify when and how WCAG success criteria should be applied: without modification or with modification (with edits and/or notes).  The intention intended that the note would help clarify when and how WCAG 2.0 success criteria should be applied, without or with modification (with edits and/or notes).  Glossary terms were also reviewed for applicability as written.  Due to time and resource limitations, as well as other factors, AAA success criteria were not addressed in the 2013 Working Group Note.
