...
*   [4.1.3 Status Messages](#status-messages)— requires information in a programmatic identifiable form. Additionally, software with closed functionality is not typically implemented using markup languages.
